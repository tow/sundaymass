...
Supabase bundle, icons, and content-addressed service worker. Commit their generated
changes together with the source. The workflow then runs `npm run stage:pages`, which
