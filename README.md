...
**The deliverable is `StJames_Mass_Planner.html`** (same as `index.html`, which is the
deploy-ready copy). It is fully self-contained and works offline — all data and both Word
